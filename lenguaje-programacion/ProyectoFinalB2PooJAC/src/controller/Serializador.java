...
public class Serializador {
    ...
    public static void serializar(List<PlanCelular> obj) {
        try ( FileOutputStream file = new FileOutputStream("planes.data/");  ObjectOutputStream outputStream = new ObjectOutputStream(file)) {
    ...
    public static List<PlanCelular> deserializar() {
        try ( FileInputStream file = new FileInputStream("planes.data");  ObjectInputStream inputStream = new ObjectInputStream(file)) {
